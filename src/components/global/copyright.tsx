...
<div className="copyright banquan inline-block text-sm text-gray-300 rounded">
        ...
        <p>©{copyright.startTime}-{endTime}<a href={copyright.href} target="_blank">{copyright.author}</a>版权所有</p>
        ...
        <p><a target="_blank" title="51la网站统计" href="https://v6.51.la/land/JfZgAjaA6gGu2lST"><img src="https://sdk.51.la/icon/1-4.png" /></a></p>
</div>
  );
};
